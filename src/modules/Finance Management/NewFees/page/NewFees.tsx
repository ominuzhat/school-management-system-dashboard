...
const TabComponent = () => {
  ...
  const viewTransferRequestPermission = GetPermission(
    dashboardData?.data?.permissions,
    moduleNames.transferrequest,
    actionNames.view
  );
  const createTransferRequestPermission = GetPermission(
    dashboardData?.data?.permissions,
    moduleNames.transferrequest,
    actionNames.add
  );
  ...
  const viewAccountPermission = GetPermission(
    dashboardData?.data?.permissions,
    moduleNames.account,
    actionNames.view
  );
  const createAccountPermission = GetPermission(
    dashboardData?.data?.permissions,
    moduleNames.account,
    actionNames.add
  );
  ...
  return (
    <div>
      ...
      <div>
        ...
        {activeTab === "transfers" &&
          (viewTransferRequestPermission && createTransferRequestPermission ? (
            <AccountTransfer />
          ) : (
            <NoPermissionData />
          ))}
        ...
        {activeTab === "account" &&
          (viewAccountPermission && createAccountPermission ? (
            <AccountTab />
          ) : (
            <NoPermissionData />
          ))}
