...
import { useDeleteProductItemMutation } from "../api/productEndPoints";
import { ProductDataTypes } from "../types/ProductTypes";
import ViewButton from "../../../common/CommonAnt/Button/ViewButton";
import UpdateProduct from "../components/UpdateProduct";

const useColumns = (): ColumnsType<ProductDataTypes> => {
  const dispatch = useDispatch();
  const [deleteCartItem] = useDeleteProductItemMutation();
